var conteudo_releases = "";
for (var i = 0; i < list.length; i++) {
    document.getElementById("releases").innerHTML = document.getElementById("releases").innerHTML +
        ...
        '            </path>' +
        '          </svg> ' + list[i].community.rating.average +
        '        </span>' +
        '      </span>' +
        '    </div>' +
        '    <div class="album__title">' +
        '      <h3>' +
        '      <a href="release.html">' + list[i].title +
        '      </a>' +
        '      </h3>' +
        '      <span>' +
        '        <a href="artist.html">' + list[i].artists_sort +
        '        </a>' +
        '      </span>' +
        '    </div>' +
        '  </div>' +
