const IMG_URL = 'assets/img/covers/';
 ...
 * @param {Array<release>} albuns Array de álbums para serem inseridos na interface principal
 */
...
document.getElementById('sidebar').addEventListener('click', (e) => {
    ...
    var sdBar = document.getElementById('sidebar_options') || new HTMLElement;
    var $elLink = sdBar.getElementsByClassName('active')[0];
    if ($elLink) {
        $elLink.classList.toggle('active');
    }
    sdBar.getElementsByClassName(link)[0].classList.toggle('active');
})
...
//@ts-ignore
document.getElementById('sortedList').innerHTML = builder.sortedList();